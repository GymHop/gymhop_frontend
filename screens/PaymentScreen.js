...
class PaymentScreen extends Component {
  ...
  componentDidUpdate(prevProps) {
    ...
    if (
      ...
      this.props.paymentSuccessful != prevProps.paymentSuccessful
    ) {
  ...
  openNativePurchaseOption = () => {
    ...
    console.log(
      "purchasing starting with option " +
      ...
      <ScrollView style={styles.container}>
        <View style={[styles.carousel]}>
          <Carousel
            ...
            onSnapToItem={(index) => this.setState({ selectedOption: index })}
          />
        </View>
        ...
        <View style={styles.termsWrap}>
          ...
          <Text style={styles.terms}>
            ...
            <Text
              ...
              onPress={() => {
                Linking.openURL(
                  "mailto:contact@gymhop.us?subject=Cancel%20Subscription&body=Let%20us%20know%20what%20we%20could%20do%20better"
                );
              }}
            >
              contact@gymhop.us
        ...
        <View>
          <TouchableOpacity
            style={[
              { backgroundColor: this.plans[this.state.selectedOption].color },
              styles.subButton,
            ]}
            onPress={this.openNativePurchaseOption}
          >
            <Text style={styles.subButtonText}>
              {this.plans[this.state.selectedOption].buttonText}
            </Text>
...
function mapDispatchToProps(dispatch) {
  return {
    createCharge: (APItoken, choosenTier, token) =>
      dispatch(createCharge(APItoken, choosenTier, token)),
  };
}
